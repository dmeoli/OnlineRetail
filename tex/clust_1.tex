...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{/clust_1/pca.png}
...
\begin{figure}[h!]
     ...
     \begin{subfigure}{0.49\textwidth}
         \centering
         \includegraphics[scale=0.4]{/clust_1/sse.png}
         \caption{SSE}
         \label{fig:sse_img}
     \end{subfigure}
     \begin{subfigure}{0.49\textwidth}
         \centering
         \includegraphics[scale=0.4]{/clust_1/perc.png}
     ...
     \begin{subfigure}{0.49\textwidth}
         \centering
         \includegraphics[scale=0.4]{/clust_1/sil.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{/clust_1/sil_tot.png}
...
\begin{figure}[h!]
    \centering
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\linewidth]{/clust_1/km_clusters.png}
        \caption{Clustering result}
        \label{fig:skmclust}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\linewidth]{/clust_1/sim_heatmap.png}
        \caption{Similarity heatmap}
        \label{fig:sim_heatmap}
    \end{subfigure}
    
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\linewidth]{/clust_1/cluster_avg.png}
...
\begin{figure}[h!]
    \centering
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\linewidth]{/clust_1/logqta_km.png}
        \caption{Distributions of \emph{logQta}}
        \label{fig:logqta}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{/clust_1/logspent_km.png}
    ...
    \end{subfigure}
        \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{/clust_1/logavgbv_km.png}
        \caption{Distribution of \emph{logAvgBasksValue}}
        \label{fig:logavgbv}
    \end{subfigure}
        \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{/clust_1/tp_entr_km.png}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{/clust_1/c_link.png}
        \caption{\emph{Complete Link}}
        \label{fig:clink_img}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{/clust_1/s_link.png}
        \caption{\emph{Single Link}}
        \label{fig:slink_img}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{/clust_1/ward.png}
        \caption{\emph{Ward}}
        \label{fig:ward_img}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
         \centering
         \includegraphics[width=0.9\linewidth]{/clust_1/centroid.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.46\paperwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{/clust_1/dbscan.png}
    ...
    \begin{subfigure}{0.45\paperwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{/clust_1/dbscan_bad.png}
