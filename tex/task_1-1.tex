...
Then, we proceed by removing the entries corresponding to the \textbf{65073} null \textit{CustomerID} values, since there is no way to integrate them to trace the original customer.
